        ...
        <div className="max-w-5xl mx-auto">
          <div className="bg-white rounded-xl shadow-lg border border-gray-200">
            <div className="p-8 border-b border-gray-200">
              <h1 className="text-3xl font-bold text-gray-900">Write Your Essay</h1>
            </div>
            <div className="p-8">
              <div className="border border-gray-300 rounded-lg p-4 h-64 flex items-center justify-center bg-gray-50">
                <div className="text-gray-500">Loading editor...</div>
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden">
          ...
          <div className="p-8 border-b border-gray-200 bg-gradient-to-r from-blue-50 to-indigo-50">
            <label className="block text-sm font-semibold text-gray-700 mb-3">Essay Title</label>
            <input
              type="text"
              placeholder="Enter a compelling title for your essay..."
              value={title}
              onChange={(e) => setTitle(e.target.value)}
              className="w-full text-2xl font-bold p-4 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none placeholder-gray-400"
            />
          </div>
          ...
          <div className="px-8 py-4 border-b border-gray-200 bg-gray-50">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-3">
                {isPublic ? <Globe className="h-5 w-5 text-green-600" /> : <Lock className="h-5 w-5 text-gray-600" />}
                <div>
                  <Label htmlFor="privacy-toggle" className="text-sm font-semibold text-gray-900">
          ...
          {/* Rich Text Editor */}
          <div className="p-8">
            <label className="block text-sm font-semibold text-gray-700 mb-4">Essay Content</label>
            <ReactQuill
              theme="snow"
              value={content}
              onChange={setContent}
          ...
          {/* Action Buttons */}
          <div className="px-8 py-6 border-t border-gray-200 bg-gray-50 flex flex-wrap gap-3 justify-end">
            <button
              onClick={handleCancel}
              className="px-6 py-2.5 text-gray-700 bg-white border border-gray-300 rounded-lg hover:bg-gray-100 transition-colors font-medium flex items-center gap-2"
            >
              <X className="h-4 w-4" />
